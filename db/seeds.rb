...
#restaurants
bandit= Restaurant.create([{name: "Bandit Taco", address_one: "4629 41st St NW", city: "Washington", state: "DC", zipcode: "20016", genre_id: "9"}])
kith= Restaurant.create([{name: "Kith and Kin", address_one: "801 Wharf Street, SW", city: "Washington", state: "DC", zipcode: "20024", genre_id: "12"}])
supra= Restaurant.create([{name: "Supra", address_one: "1205 11th Street NW", city: "Washington", state: "DC", zipcode: "20001", genre_id: "13"}])
caddies= Restaurant.create([{name: "Caddies", address_one: "4922 Cordell Avenue", city: "Bethesda", state: "MD", zipcode: "20814", genre_id: "3"}])
texas= Restaurant.create([{name: "Texas Jacks Barbecue", address_one: "2761 Washington Blvd", city: "Arlington", state: "VA", zipcode: "22201", genre_id: "7"}])
